...
const BaliHoneymoonBestSeller = () => {
  ...
  const packageDetails = {
    title: "HONEYMOON BEST SELLER",
    duration: "6N / 7D",
    location: "Umalas & Ubud, Bali",
    rating: "4-5",
    price: "₹93,650/- For a Couple",
    excludes: "Excluding Airfare"
  };
  ...
  const hotels = [
    ...
    },
    {
      name: "Swan Paradise",
      nights: "3 Nights",
      roomType: "Superior room with Breakfast",
      location: "Ubud, Bali",
      rating: 4,
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=300&fit=crop&crop=center",
      link: "https://swanparadisebali.com/?gad_source=1&gbraid=0AAAAA-ZGWwQsw1lRXmJNt1FHKcL-BLLcb&gclid=Cj0KCQjwiLLABhCEARIsAJYS6ulbY67FjqcpKzaniIk6NXulgD1xr89IG-zbSrZsj7QlVpsDIZuWLscaLcb&gclid=Cj0KCQjwiLLABhCEARIsAJYS6ulbY67FjqcpKzaniIk6NXulgD1xr89IG-zbSrZsj7QlVpsDIZuWLscaAlyEEALw_wcB",
      benefits: [
  ...
  const packageHighlights = [
    ...
    "Floating Breakfast & Honeymoon Amenities",
    "Water Sports Adventure Package", 
...
export default BaliHoneymoonBestSeller; 