...
const DynamicThailandItineraryPage = () => {
  ...
  // Hero images from Thailand
  const sliderImages = [
    {
      src: "/Destination/ThailandHero/image1.jpg",
      alt: "Bangkok Temples",
      title: "Bangkok Temples",
      subtitle: "Ancient spirituality meets modern city life",
      description: "Discover the sacred temples and rich cultural heritage of Thailand's vibrant capital."
    },
    {
      src: "/Destination/ThailandHero/image2.jpg", 
      alt: "Phuket Beaches",
      title: "Phuket Beaches",
      subtitle: "Crystal clear waters and pristine sands",
      description: "Relax on the world-famous beaches of Phuket with stunning ocean views."
    },
    {
      src: "/Destination/ThailandHero/image3.jpg",
      alt: "Chiang Mai Culture",
      title: "Chiang Mai Culture",
      subtitle: "Traditional charm and northern hospitality",
      description: "Experience the authentic culture and traditions of northern Thailand."
    },
    {
      src: "/Destination/ThailandHero/image4.jpg",
      alt: "Thai Cuisine",
      title: "Thai Cuisine",
      subtitle: "Flavors that dance on your palate",
      description: "Savor the authentic tastes and aromas of world-renowned Thai cuisine."
    }
  ];
  ...
  const fetchItinerary = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/destinations/thailand/itineraries?t=${timestamp}`, {
      ...
      if (response.ok) {
        ...
        // Ensure itineraries is always an array before calling .find()
        ...
        const matchingItinerary = itineraries.find((it: any) => {
          ...
          return String(it.packageId) === String(params.packageId);
        });
        ...
        if (matchingItinerary) {
          ...
          if (itineraries.length === 0) {
            setError('No itineraries found in database');
          } else {
            setError(`No itinerary found for package ID: ${params.packageId}. Found ${itineraries.length} itineraries.`);
          }
        }
      } else {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Gallery Hero Section - Same as Thailand Page */}
...
export default DynamicThailandItineraryPage; 