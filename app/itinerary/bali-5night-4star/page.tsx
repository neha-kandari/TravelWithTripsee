...
const Bali5Night4Star = () => {
  ...
  const packageDetails = {
    title: "5 NIGHTS 4 STAR PACKAGE",
    duration: "5N / 6D",
    location: "Kuta & Ubud, Bali",
    rating: "4",
    price: "₹88,220/- For a Couple",
    excludes: "Excluding Flights"
  };

  const hotels = [
    {
      name: "Golden Tulip Jineng Resort",
      nights: "3 Nights",
      ...
      link: "https://jineng-resort-bali.goldentulip.com/en-us/?sr=SEO_GOOGLE",
      benefits: []
    },
    {
      name: "Desa Swan Villa",
      nights: "2 Nights",
      ...
      link: "https://www.desaswan.com/accommodations/one-bedroom-private-pool-villa",
      benefits: []
    }
  ];
  ...
  const itinerary = [
    ...
    },
    {
      ...
      highlight: "Thrilling Water Sports"
    },
    {
      day: 3,
    ...
    },
    {
      ...
      highlight: "Sacred Temple Journey"
    },
    {
      day: 5,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <p className="text-3xl font-bold text-rose-500">5 Days</p>
                      <p className="text-3xl font-bold text-gray-400">4 Nights</p>
                    </div>
                  </div>
...
export default Bali5Night4Star; 