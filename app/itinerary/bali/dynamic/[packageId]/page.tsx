...
const DynamicBaliItineraryPage = () => {
  ...
  const fetchItinerary = async () => {
    try {
      ...
      const response = await fetch(`/api/admin/itineraries?destination=bali&packageId=${params.packageId}&t=${timestamp}`, {
...
export default DynamicBaliItineraryPage; 