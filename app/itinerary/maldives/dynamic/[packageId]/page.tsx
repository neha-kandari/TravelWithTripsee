...
const DynamicMaldivesItineraryPage = () => {
  ...
  // Hero images from Maldives
  const sliderImages = [
    {
      src: "/Destination/MaldivesHero/Gulhi Falhu.jpg",
      alt: "Gulhi Falhu",
      title: "Gulhi Falhu",
      subtitle: "Pristine island paradise with crystal clear waters",
      description: "Discover the untouched beauty of Gulhi Falhu with its crystal clear waters and pristine beaches."
    },
    {
      src: "/Destination/MaldivesHero/Hanifaru Bay.jpg", 
      alt: "Hanifaru Bay",
      title: "Hanifaru Bay",
      subtitle: "UNESCO Biosphere Reserve and marine sanctuary",
      description: "Experience the incredible marine life at Hanifaru Bay, a UNESCO Biosphere Reserve famous for manta ray gatherings."
    },
    {
      src: "/Destination/MaldivesHero/Malé Atoll.jpg",
      alt: "Malé Atoll",
      title: "Malé Atoll",
      subtitle: "Capital atoll and gateway to paradise",
      description: "Explore the vibrant capital atoll with its rich culture, bustling markets, and stunning natural beauty."
    },
    {
      src: "/Destination/MaldivesHero/Meedhoo.jpg",
      alt: "Meedhoo, Raa Atoll",
      title: "Meedhoo, Raa Atoll",
      subtitle: "Traditional island charm and local culture",
      description: "Experience serene island life and discover local Maldivian culture in the beautiful Raa Atoll."
    }
  ];
  ...
  const fetchItinerary = async () => {
    try {
      setLoading(true);
      console.log('Fetching itinerary for packageId:', params.packageId);
      
      // Add cache busting to ensure fresh data
      const timestamp = new Date().getTime();
      const response = await fetch(`/api/admin/destinations/maldives/itineraries?packageId=${params.packageId}&t=${timestamp}`, {
      ...
      if (response.ok) {
        ...
        console.log('API itineraries:', itineraries);
        
        const matchingItinerary = itineraries.find((it: any) => it.packageId === params.packageId);
        console.log('Matching itinerary found:', matchingItinerary);
...
export default DynamicMaldivesItineraryPage; 