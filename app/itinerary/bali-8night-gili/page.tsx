            ...
            <div className="lg:col-span-2 bg-white rounded-lg p-6 shadow-lg max-h-screen overflow-y-auto">
              ...
              <div className="mb-6 pb-6 border-b">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h2 className="text-4xl font-bold text-gray-900 mb-3">🏝️ {packageDetails.title}</h2>
                    <div className="space-y-1">
                      <p className="text-3xl font-bold text-rose-500">8 Days</p>
                      <p className="text-3xl font-bold text-gray-400">7 Nights</p>
                    </div>
                  </div>
