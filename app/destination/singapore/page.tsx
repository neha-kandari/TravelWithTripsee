...
const SingaporePage = () => {
  ...
  //     highlights: "Infinity pool • Gardens by the Bay • Singapore Flyer • Fine dining"
  //   },
  //   {
  ...
  //     highlights: "Merlion Park • Chinatown • Little India • Arab Street"
  //   },
  //   {
  ...
  //     highlights: "Universal Studios • S.E.A. Aquarium • Night Safari • Jurong Bird Park"
  //   },
  //   {
  ...
  //     highlights: "Hawker centers • Cultural districts • Sky diving • River safari"
  //   },
  //   {
  //     image: "/destination/singaporeHero/image1.jpg",
  ...
  //     highlights: "Michelin dining • Private yacht • Helicopter tour • Exclusive experiences"
  //   }
  // ];
